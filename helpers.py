...
def apply_cal_to_model(thorax_virtual_IMU, humerus_virtual_IMU, radius_virtual_IMU, model_file):
...
def run_osim_IMU_IK(IMU_IK_settings_file, calibrated_model_file, orientations_file, results_directory, trim_bool,
               start_time, end_time, IK_output_file_name):
    ...
    imuIK.set_sensor_to_opensim_rotations(osim.Vec3(0, 0, 0))
